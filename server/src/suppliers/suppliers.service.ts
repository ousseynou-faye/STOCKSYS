...
export class SuppliersService {
  ...
  async create(data: any) {
    // N'autoriser que les champs supportés par le schéma
    const payload: any = {
      name: data.name,
  ...
  addProduct(supplierId: string, data: any) {
    return this.prisma.supplierProduct.create({ data: { supplierId, variationId: data.variationId, purchasePrice: data.purchasePrice, supplierSku: data.supplierSku } });
  }
